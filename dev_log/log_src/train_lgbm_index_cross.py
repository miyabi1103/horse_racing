...
class Trainer_lightgbm_index_cv:
    def __init__(
        self, 
        input_dir: Path = INPUT_DIR, 
        features_filename: str = "features.csv", 
    ...
    def run(
        self, 
        n_splits: int = 10, 
        importance_filename: str = "importance_lightgbm_index_cv", 
        model_filename: str = "model_lightgbm_index_cv.pkl", 
        evaluation_filename: str = "evaluation_lightgbm_index_cv.csv", 
        final_model_filename: str = "model_lightgbm_index_cv_full.pkl"
    ):
