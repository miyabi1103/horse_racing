...
class FeatureCreator:
    ...
    def cross_features_2(self):
        ...
        df = (
            ...
            .merge(self.race_info[["race_id", "place","race_class","around","weather","ground_state","course_len","race_type"]], on="race_id")
        )
        ...
        # 距離/競馬場/タイプ/レースランク
        df["distance_place_type_race_class"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["race_class"].astype(str)).astype(int)
        # 距離/競馬場/タイプ/枠順
        ...
        df["distance_place_type_wakuban_race_class"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["wakuban"].astype(str) + df["race_class"].astype(str)).astype(int)
        # 距離/競馬場/タイプ/馬番/レースランク
        df["distance_place_type_umaban_race_class"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["umaban"].astype(str) + df["race_class"].astype(str)).astype(int)
        # 距離/競馬場/タイプ/枠順/直線
        ...
        df["distance_place_type_race_class_weather"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["race_class"].astype(str) + df["weather"].astype(str)).astype(int)
        # 距離/タイプ/馬場状態
        ...
        df["distance_place_type_race_class_ground_state"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["race_class"].astype(str) + df["ground_state"].astype(str)).astype(int)
        # 距離/タイプ/性別
        ...
        df["distance_place_type_race_class_sex"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["race_class"].astype(str) + df["sex"].astype(str)).astype(int)
        # 距離/タイプ/性別/天気
        ...
        df["distance_place_type_race_class_sex_weather"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["race_class"].astype(str) + df["sex"].astype(str) + df["weather"].astype(str)).astype(int)
        # 距離/タイプ/性別/馬場状態
        ...
        df["distance_place_type_race_class_sex_ground_state"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["race_class"].astype(str) + df["sex"].astype(str) + df["ground_state"].astype(str)).astype(int)
        # 距離/タイプ/直線
        ...
        df["distance_place_type_race_class_straight"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["race_class"].astype(str) + df["around"].astype(str)).astype(int)
        # 距離/タイプ/直線/馬場状態
        ...
        df["distance_place_type_race_class_straight_ground_state"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["race_class"].astype(str) + df["around"].astype(str) + df["ground_state"].astype(str)).astype(int)

        # 距離/競馬場/タイプ/馬番/レースランク/直線/天気/馬場状態
        df["distance_place_type_umaban_race_class_around_weather_ground_state"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str) + df["umaban"].astype(str) + df["race_class"].astype(str)+ df["around"].astype(str) + df["ground_state"].astype(str)+ df["weather"].astype(str)).astype(int)        
        # 距離/競馬場/タイプレースランク/直線/天気/馬場状態
        df["distance_place_type_race_class_around_weather_ground_state"] = (df["course_len"].astype(str) + df["place"].astype(str) + df["race_type"].astype(str)  + df["race_class"].astype(str)+ df["around"].astype(str) + df["ground_state"].astype(str)+ df["weather"].astype(str)).astype(int)
        # 距離/競馬場/タイプ/馬場状態/天気
        ...
        baselog = (
            self.population.merge(
                self.race_info[["race_id", "course_len", "race_type", "around"]], on="race_id"
            )
            .merge(
                self.horse_results,
                on=["horse_id", "course_len", "race_type"],
        ...
        df_old = (
            baselog
            .merge(self.results[["race_id", "horse_id", "sex"]], on=["race_id", "horse_id"])
        )
        ...
        # 距離/競馬場/タイプ/枠順/レースランク
        df_old["distance_place_type_wakuban_race_class"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["wakuban"].astype(str) + df_old["race_class"].astype(str)).astype(int)
        # 距離/競馬場/タイプ/馬番/レースランク
        df_old["distance_place_type_umaban_race_class"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["umaban"].astype(str) + df_old["race_class"].astype(str)).astype(int)
        # 距離/競馬場/タイプ/枠順/直線
        ...
        # 距離/競馬場/タイプ/レースランク/天気
        df_old["distance_place_type_race_class_weather"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["race_class"].astype(str) + df_old["weather"].astype(str)).astype(int)
        # 距離/タイプ/馬場状態
        ...
        # 距離/競馬場/タイプ/レースランク/馬場状態
        df_old["distance_place_type_race_class_ground_state"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["race_class"].astype(str) + df_old["ground_state"].astype(str)).astype(int)
        # 距離/タイプ/性別
        ...
        # 距離/競馬場/タイプ/レースランク/性別
        df_old["distance_place_type_race_class_sex"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["race_class"].astype(str) + df_old["sex"].astype(str)).astype(int)
        # 距離/タイプ/性別/天気
        ...
        # 距離/競馬場/タイプ/レースランク/性別/天気
        df_old["distance_place_type_race_class_sex_weather"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["race_class"].astype(str) + df_old["sex"].astype(str) + df_old["weather"].astype(str)).astype(int)
        # 距離/タイプ/性別/馬場状態
        ...
        # 距離/競馬場/タイプ/レースランク/性別/馬場状態
        df_old["distance_place_type_race_class_sex_ground_state"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["race_class"].astype(str) + df_old["sex"].astype(str) + df_old["ground_state"].astype(str)).astype(int)
        # 距離/タイプ/直線
        ...
        # 距離/競馬場/タイプ/レースランク/直線
        df_old["distance_place_type_race_class_straight"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["race_class"].astype(str) + df_old["around"].astype(str)).astype(int)
        # 距離/タイプ/直線/馬場状態
        ...
        # 距離/競馬場/タイプ/レースランク/直線/馬場状態
        df_old["distance_place_type_race_class_straight_ground_state"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["race_class"].astype(str) + df_old["around"].astype(str) + df_old["ground_state"].astype(str)).astype(int)
        

        # 距離/競馬場/タイプ/馬番/レースランク/直線/天気/馬場状態
        df_old["distance_place_type_umaban_race_class_around_weather_ground_state"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str) + df_old["umaban"].astype(str) + df_old["race_class"].astype(str)+ df_old["around"].astype(str) + df_old["ground_state"].astype(str)+ df_old["weather"].astype(str)).astype(int)        
        # 距離/競馬場/タイプレースランク/直線/天気/馬場状態
        df_old["distance_place_type_race_class_around_weather_ground_state"] = (df_old["course_len"].astype(str) + df_old["place"].astype(str) + df_old["race_type"].astype(str)  + df_old["race_class"].astype(str)+ df_old["around"].astype(str) + df_old["ground_state"].astype(str)+ df_old["weather"].astype(str)).astype(int)    
        ...
        # 距離/競馬場/タイプ/枠順/レースランク
        target_mean_1 = df_old.groupby("distance_place_type_wakuban_race_class")["time"].mean()
        df_old["distance_place_type_wakuban_race_class_encoded"] = df_old["distance_place_type_wakuban_race_class"].map(target_mean_1)
        
        # 距離/競馬場/タイプ/馬番/レースランク
        target_mean_1 = df_old.groupby("distance_place_type_umaban_race_class")["time"].mean()
        df_old["distance_place_type_umaban_race_class_encoded"] = df_old["distance_place_type_umaban_race_class"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/天気
        target_mean_1 = df_old.groupby("distance_place_type_race_class_weather")["time"].mean()
        df_old["distance_place_type_race_class_weather_encoded"] = df_old["distance_place_type_race_class_weather"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/馬場状態
        target_mean_1 = df_old.groupby("distance_place_type_race_class_ground_state")["time"].mean()
        df_old["distance_place_type_race_class_ground_state_encoded"] = df_old["distance_place_type_race_class_ground_state"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/性別
        target_mean_1 = df_old.groupby("distance_place_type_race_class_sex")["time"].mean()
        df_old["distance_place_type_race_class_sex_encoded"] = df_old["distance_place_type_race_class_sex"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/性別/天気
        target_mean_1 = df_old.groupby("distance_place_type_race_class_sex_weather")["time"].mean()
        df_old["distance_place_type_race_class_sex_weather_encoded"] = df_old["distance_place_type_race_class_sex_weather"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/性別/馬場状態
        target_mean_1 = df_old.groupby("distance_place_type_race_class_sex_ground_state")["time"].mean()
        df_old["distance_place_type_race_class_sex_ground_state_encoded"] = df_old["distance_place_type_race_class_sex_ground_state"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/直線
        target_mean_1 = df_old.groupby("distance_place_type_race_class_straight")["time"].mean()
        df_old["distance_place_type_race_class_straight_encoded"] = df_old["distance_place_type_race_class_straight"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/直線/馬場状態
        target_mean_1 = df_old.groupby("distance_place_type_race_class_straight_ground_state")["time"].mean()
        df_old["distance_place_type_race_class_straight_ground_state_encoded"] = df_old["distance_place_type_race_class_straight_ground_state"].map(target_mean_1)


        
        target_mean_1 = df_old.groupby("distance_place_type_umaban_race_class_around_weather_ground_state")["time"].mean()
        # 平均値をカテゴリ変数にマッピング
        df_old["distance_place_type_umaban_race_class_around_weather_ground_state_encoded"] = df_old["distance_place_type_umaban_race_class_around_weather_ground_state"].map(target_mean_1)

        target_mean_1 = df_old.groupby("distance_place_type_race_class_around_weather_ground_state")["time"].mean()
        # 平均値をカテゴリ変数にマッピング
        df_old["distance_place_type_race_class_around_weather_ground_state_encoded"] = df_old["distance_place_type_race_class_around_weather_ground_state"].map(target_mean_1)
        ...
        #noboriの平均
        target_mean_1 = df_old.groupby("distance_place_type_umaban_race_class_around_weather_ground_state")["nobori"].mean()
        # 平均値をカテゴリ変数にマッピング
        df_old["distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded"] = df_old["distance_place_type_umaban_race_class_around_weather_ground_state"].map(target_mean_1)
        
        target_mean_1 = df_old.groupby("distance_place_type_race_class")["nobori"].mean()
        # 平均値をカテゴリ変数にマッピング
        df_old["distance_place_type_race_class_nobori_encoded"] = df_old["distance_place_type_race_class"].map(target_mean_1)
        ...
        df_old = df_old[["distance_type", "distance_place_type", 
                        "distance_place_type_race_class", "distance_place_type_wakuban", "distance_place_type_umaban", 
                        "distance_place_type_wakuban_race_class", "distance_place_type_umaban_race_class", 
                        ...
                        "distance_type_weather", "distance_place_type_weather", "distance_place_type_race_class_weather", 
                        "distance_type_ground_state", "distance_place_type_ground_state", "distance_place_type_race_class_ground_state", 
                        "distance_type_sex", "distance_place_type_sex", "distance_place_type_race_class_sex", 
                        "distance_type_sex_weather", "distance_place_type_sex_weather", "distance_place_type_race_class_sex_weather", 
                        "distance_type_sex_ground_state", "distance_place_type_sex_ground_state", 
                        "distance_place_type_race_class_sex_ground_state", "distance_type_straight", 
                        "distance_place_type_straight", "distance_place_type_race_class_straight", 
                        "distance_type_straight_ground_state", "distance_place_type_straight_ground_state", "distance_place_type_race_class_around_weather_ground_state",
                "distance_place_type_umaban_race_class_around_weather_ground_state",
                        "distance_place_type_race_class_straight_ground_state", 
                        ...
                        'distance_type_encoded', 'distance_place_type_encoded', 'distance_place_type_race_class_encoded', 'distance_place_type_wakuban_encoded', 'distance_place_type_umaban_encoded', 'distance_place_type_wakuban_race_class_encoded', 'distance_place_type_umaban_race_class_encoded', 'distance_place_type_wakuban_straight_encoded', 'distance_place_type_umaban_straight_encoded', 'distance_place_type_wakuban_ground_state_encoded', 'distance_place_type_umaban_ground_state_encoded', 'distance_place_type_wakuban_ground_state_straight_encoded', 'distance_place_type_umaban_ground_state_straight_encoded', 'distance_type_weather_encoded', 'distance_place_type_weather_encoded', 'distance_place_type_race_class_weather_encoded', 'distance_type_ground_state_encoded', 'distance_place_type_ground_state_encoded', 'distance_place_type_race_class_ground_state_encoded', 'distance_type_sex_encoded', 'distance_place_type_sex_encoded', 'distance_place_type_race_class_sex_encoded', 'distance_type_sex_weather_encoded', 'distance_place_type_sex_weather_encoded', 'distance_place_type_race_class_sex_weather_encoded', 'distance_type_sex_ground_state_encoded', 'distance_place_type_sex_ground_state_encoded', 'distance_place_type_race_class_sex_ground_state_encoded', 'distance_type_straight_encoded', 'distance_place_type_straight_encoded', 'distance_place_type_race_class_straight_encoded', 'distance_type_straight_ground_state_encoded', 'distance_place_type_straight_ground_state_encoded', 'distance_place_type_race_class_straight_ground_state_encoded',"distance_place_type_race_class_around_weather_ground_state_encoded","distance_place_type_umaban_race_class_around_weather_ground_state_encoded","distance_place_type_ground_state_weather_encoded",
                         
                         "distance_place_type_ground_state_weather_nobori_encoded","distance_place_type_nobori_encoded","distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded","distance_place_type_race_class_nobori_encoded",
        ...
        columns_to_copy = [
            ...
            "distance_place_type_ground_state_weather",
            "distance_place_type_umaban_race_class_around_weather_ground_state", 
            "distance_place_type_race_class",
        ...
        columns_to_merge = [
            ...
            ("distance_place_type_wakuban_race_class", 'distance_place_type_wakuban_race_class_encoded'),
            ("distance_place_type_umaban_race_class", 'distance_place_type_umaban_race_class_encoded'),
            ...
            ("distance_place_type_race_class_weather", 'distance_place_type_race_class_weather_encoded'),
            ...
            ("distance_place_type_race_class_ground_state", 'distance_place_type_race_class_ground_state_encoded'),
            ("distance_type_sex", 'distance_type_sex_encoded'),
            ("distance_place_type_sex", 'distance_place_type_sex_encoded'),
            ("distance_place_type_race_class_sex", 'distance_place_type_race_class_sex_encoded'),
            ...
            ("distance_place_type_race_class_sex_weather", 'distance_place_type_race_class_sex_weather_encoded'),
            ...
            ("distance_place_type_race_class_sex_ground_state", 'distance_place_type_race_class_sex_ground_state_encoded'),
            ("distance_type_straight", 'distance_type_straight_encoded'),
            ("distance_place_type_straight", 'distance_place_type_straight_encoded'),
            ("distance_place_type_race_class_straight", 'distance_place_type_race_class_straight_encoded'),
            ...
            ("distance_place_type_race_class_straight_ground_state", 'distance_place_type_race_class_straight_ground_state_encoded'),
            
            ("distance_place_type_umaban_race_class_around_weather_ground_state", "distance_place_type_umaban_race_class_around_weather_ground_state_encoded"),
            ("distance_place_type_race_class_around_weather_ground_state", "distance_place_type_race_class_around_weather_ground_state_encoded"), 
            ...
            ("distance_place_type_umaban_race_class_around_weather_ground_state_copy", "distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded"), 
             
            ("distance_place_type_race_class_copy", "distance_place_type_race_class_nobori_encoded"), 
        ...
        merged_df = merged_df.merge(
            df[[
                ...
                "distance_place_type_race_class_straight_ground_state",
                "distance_place_type_race_class_around_weather_ground_state",
                "distance_place_type_umaban_race_class_around_weather_ground_state",
                "distance_place_type_ground_state_weather",
                ...
                "distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded","distance_place_type_race_class_nobori_encoded","distance_place_type_ground_state_weather_nobori_encoded","distance_place_type_nobori_encoded","mean_fukusho_rate_wakuban","mean_fukusho_rate_umaban"
            ]],
            on=["race_id", "date", "horse_id"],
            how="left"
        )
    ...
    def cross_features_3(
        ...
        # ターゲットエンコーディングを計算（カテゴリごとのtimeの平均）
        target_mean_1 = df.groupby("distance_place_type_race_class")["time"].mean()
        # 平均値をカテゴリ変数にマッピング
        df["distance_place_type_race_class_encoded"] = df["distance_place_type_race_class"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/枠順/レースランク
        target_mean_1 = df.groupby("distance_place_type_wakuban_race_class")["time"].mean()
        df["distance_place_type_wakuban_race_class_encoded"] = df["distance_place_type_wakuban_race_class"].map(target_mean_1)
        
        # 距離/競馬場/タイプ/馬番/レースランク
        target_mean_1 = df.groupby("distance_place_type_umaban_race_class")["time"].mean()
        df["distance_place_type_umaban_race_class_encoded"] = df["distance_place_type_umaban_race_class"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/天気
        target_mean_1 = df.groupby("distance_place_type_race_class_weather")["time"].mean()
        df["distance_place_type_race_class_weather_encoded"] = df["distance_place_type_race_class_weather"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/馬場状態
        target_mean_1 = df.groupby("distance_place_type_race_class_ground_state")["time"].mean()
        df["distance_place_type_race_class_ground_state_encoded"] = df["distance_place_type_race_class_ground_state"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/性別
        target_mean_1 = df.groupby("distance_place_type_race_class_sex")["time"].mean()
        df["distance_place_type_race_class_sex_encoded"] = df["distance_place_type_race_class_sex"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/性別/天気
        target_mean_1 = df.groupby("distance_place_type_race_class_sex_weather")["time"].mean()
        df["distance_place_type_race_class_sex_weather_encoded"] = df["distance_place_type_race_class_sex_weather"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/性別/馬場状態
        target_mean_1 = df.groupby("distance_place_type_race_class_sex_ground_state")["time"].mean()
        df["distance_place_type_race_class_sex_ground_state_encoded"] = df["distance_place_type_race_class_sex_ground_state"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/直線
        target_mean_1 = df.groupby("distance_place_type_race_class_straight")["time"].mean()
        df["distance_place_type_race_class_straight_encoded"] = df["distance_place_type_race_class_straight"].map(target_mean_1)
        ...
        # 距離/競馬場/タイプ/レースランク/直線/馬場状態
        target_mean_1 = df.groupby("distance_place_type_race_class_straight_ground_state")["time"].mean()
        df["distance_place_type_race_class_straight_ground_state_encoded"] = df["distance_place_type_race_class_straight_ground_state"].map(target_mean_1)

        
        target_mean_1 = df.groupby("distance_place_type_umaban_race_class_around_weather_ground_state")["time"].mean()
        # 平均値をカテゴリ変数にマッピング
        df["distance_place_type_umaban_race_class_around_weather_ground_state_encoded"] = df["distance_place_type_umaban_race_class_around_weather_ground_state"].map(target_mean_1)

        target_mean_1 = df.groupby("distance_place_type_race_class_around_weather_ground_state")["time"].mean()
        # 平均値をカテゴリ変数にマッピング
        df["distance_place_type_race_class_around_weather_ground_state_encoded"] = df["distance_place_type_race_class_around_weather_ground_state"].map(target_mean_1)
        ...
        #noboriの平均
        target_mean_1 = df.groupby("distance_place_type_umaban_race_class_around_weather_ground_state")["nobori"].mean()
        # 平均値をカテゴリ変数にマッピング
        df["distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded"] = df["distance_place_type_umaban_race_class_around_weather_ground_state"].map(target_mean_1)
        
        target_mean_1 = df.groupby("distance_place_type_race_class")["nobori"].mean()
        # 平均値をカテゴリ変数にマッピング
        df["distance_place_type_race_class_nobori_encoded"] = df["distance_place_type_race_class"].map(target_mean_1)
        ...
        for col in df.columns:
            if "_nobori_encoded" in col:
                new_columns[f"{col}_time_diff"] = df[col] - df["nobori"]
                
                if "_class" in col:
                
                    # # rank と平均タイムの和
                    # new_columns[f"{col}_rank_sumprod"] = df[col] + df["rank"]
                    
                    # # rank と平均タイムの積
                    # new_columns[f"{col}_rank_multiprod"] = df[col] * df["rank"]
                    
                    # rankdiff + 1 と平均タイムの和
                    new_columns[f"{col}_rank_diff_sumprod"] = df[col] + (df["rank_diff"] + 1)
                    
                    # rankdiff + 1 と平均タイムの積
                    new_columns[f"{col}_rank_diff_multiprod"] = df[col] * (df["rank_diff"] + 1)
        
                elif "_wakuban" in col:
                    
                    # 頭数/rankdiff + 1 と平均タイムの和
                    new_columns[f"{col}_rank_diff_sumprod"] = df[col] + (1/(df["rank_diff"] + 1))
                    
                    # 頭数/rankdiff + 1 と平均タイムの積
                    new_columns[f"{col}_rank_diff_multiprod"] = df[col] * (1/(df["rank_diff"] + 1))
                ...
                # 平均タイムとの差
                new_columns[f"{col}_time_diff"] = df[col] - df["time"]
...
# dfから必要なカラムだけを選択
        df = df[["race_id", "horse_id", 'distance_type_encoded_time_diff', 
                'distance_place_type_encoded_time_diff', 
                'distance_place_type_race_class_encoded_time_diff',
                'distance_place_type_race_class_encoded_rank_diff_sumprod', 
                'distance_place_type_race_class_encoded_rank_diff_multiprod', 
                ...
                'distance_place_type_wakuban_race_class_encoded_time_diff', 
                'distance_place_type_wakuban_race_class_encoded_rank_diff_sumprod', 
                'distance_place_type_wakuban_race_class_encoded_rank_diff_multiprod', 
                'distance_place_type_umaban_race_class_encoded_time_diff', 
                'distance_place_type_umaban_race_class_encoded_rank_diff_sumprod', 
                'distance_place_type_umaban_race_class_encoded_rank_diff_multiprod', 
                ...
                'distance_place_type_race_class_weather_encoded_time_diff', 
                'distance_place_type_race_class_weather_encoded_rank_diff_sumprod', 
                'distance_place_type_race_class_weather_encoded_rank_diff_multiprod', 
                'distance_type_ground_state_encoded_time_diff',
                'distance_place_type_ground_state_encoded_time_diff', 
                'distance_place_type_race_class_ground_state_encoded_time_diff', 
                'distance_place_type_race_class_ground_state_encoded_rank_diff_sumprod', 
                'distance_place_type_race_class_ground_state_encoded_rank_diff_multiprod', 
                'distance_type_sex_encoded_time_diff', 
                'distance_place_type_sex_encoded_time_diff', 
                'distance_place_type_race_class_sex_encoded_time_diff', 
                'distance_place_type_race_class_sex_encoded_rank_diff_sumprod', 
                'distance_place_type_race_class_sex_encoded_rank_diff_multiprod', 
                'distance_type_sex_weather_encoded_time_diff', 
                'distance_place_type_sex_weather_encoded_time_diff', 
                'distance_place_type_race_class_sex_weather_encoded_time_diff', 
                'distance_place_type_race_class_sex_weather_encoded_rank_diff_sumprod', 
                'distance_place_type_race_class_sex_weather_encoded_rank_diff_multiprod', 
                'distance_type_sex_ground_state_encoded_time_diff', 
                'distance_place_type_sex_ground_state_encoded_time_diff', 
                'distance_place_type_race_class_sex_ground_state_encoded_time_diff', 
                'distance_place_type_race_class_sex_ground_state_encoded_rank_diff_sumprod', 
                'distance_place_type_race_class_sex_ground_state_encoded_rank_diff_multiprod', 
                'distance_type_straight_encoded_time_diff', 
                'distance_place_type_straight_encoded_time_diff', 
                'distance_place_type_race_class_straight_encoded_time_diff', 
                'distance_place_type_race_class_straight_encoded_rank_diff_sumprod', 
                'distance_place_type_race_class_straight_encoded_rank_diff_multiprod', 
                'distance_type_straight_ground_state_encoded_time_diff', 
                'distance_place_type_straight_ground_state_encoded_time_diff', 
                'distance_place_type_race_class_straight_ground_state_encoded_time_diff', 
                 
                'distance_place_type_race_class_straight_ground_state_encoded_rank_diff_sumprod', 
                'distance_place_type_race_class_straight_ground_state_encoded_rank_diff_multiprod',
                 
                "distance_place_type_umaban_race_class_around_weather_ground_state_encoded_time_diff",
"distance_place_type_race_class_around_weather_ground_state_encoded_time_diff",
"distance_place_type_umaban_race_class_around_weather_ground_state_encoded_rank_diff_sumprod",
"distance_place_type_race_class_around_weather_ground_state_encoded_rank_diff_sumprod",
"distance_place_type_umaban_race_class_around_weather_ground_state_encoded_rank_diff_multiprod",
"distance_place_type_race_class_around_weather_ground_state_encoded_rank_diff_multiprod",
                 "distance_place_type_ground_state_weather_encoded_time_diff",
                 
                 
                 "distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded_time_diff",
                 "distance_place_type_race_class_nobori_encoded_time_diff",
                 "distance_place_type_ground_state_weather_nobori_encoded_time_diff",
                 "distance_place_type_nobori_encoded_time_diff",
                 
                 "distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded_rank_diff_sumprod",
                 
                 "distance_place_type_race_class_nobori_encoded_rank_diff_sumprod",
                 "distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded_rank_diff_multiprod",
                 
                 "distance_place_type_race_class_nobori_encoded_rank_diff_multiprod",
]]

        baselog = pd.merge(df, baselog, on=["race_id", "horse_id"], how="left")        
        ...
        for n_race in tqdm(n_races, desc="agg_cross_encoded"):
            ...
            df.columns = [
                "_".join(col) + f"_{n_race}races_cross_encoded" for col in df.columns
            ]
    ...
    def cross_features_4(
        ...
        baselog = (
            self.population.merge(
                self.race_info[["race_id", "course_len", "race_type", "around",'place_season_condition_type_categori']], on="race_id"
            )
            .merge(
                self.horse_results,
                on=["horse_id", "course_len", "race_type"],
        ...
        #noboriの平均
        target_mean_1 = df_old.groupby("distance_place_type_race_class_around_weather_ground_state")["nobori"].mean()
        # 平均値をカテゴリ変数にマッピング
        df_old["distance_place_type_race_class_around_weather_ground_state_nobori_encoded"] = df_old["distance_place_type_race_class_around_weather_ground_state"].map(target_mean_1)
        
        #pace_1の平均
        target_mean_1 = df_old.groupby("distance_place_type_race_class_around_weather_ground_state")["pace_1"].mean()
        # 平均値をカテゴリ変数にマッピング
        df_old["distance_place_type_race_class_around_weather_ground_state_pace_1_encoded"] = df_old["distance_place_type_race_class_around_weather_ground_state"].map(target_mean_1)
        
        df_old = df_old[["distance_place_type_race_class_around_weather_ground_state","distance_place_type_race_class_around_weather_ground_state_nobori_encoded","distance_place_type_race_class_around_weather_ground_state_pace_1_encoded"]]
        
        columns_to_merge = [("distance_place_type_race_class_around_weather_ground_state","distance_place_type_race_class_around_weather_ground_state_nobori_encoded"),
                           ("distance_place_type_race_class_around_weather_ground_state","distance_place_type_race_class_around_weather_ground_state_pace_1_encoded")]
        ...
        ＿コードの文章
        使用する列は
        rank_diff（着差）、race_class(レースグレード),corner_1_horse,corner_2_horse,corner_3_horse,corner_4_horse(コーナー順位/頭数,_3と_4は欠損値もある),race_id(レースのid),horse_id（出走馬のid）,nobori(のぼり3ハロン),"distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded_time_diff"（出走レースのnoboriの平均値）,course_len(距離)
        列は全て作成してあるものとするrace_classのカテゴリ数値は以下のようになっており、グレードが上がるほど、数値が上がるものとする
        ...
        これらの列からrank_diffとrace_classの二つを使い、当該レースの当該馬のスコアを決定する
        なお、rank_diffは数が少なければ強く、race_classは数が増えるほど強いことに留意
        ...
        # rank_diffとrace_classを利用した基本スコアを計算
        df["base_score"] = 1 / df["adjusted_rank_diff"] *(df["race_class"]+1 )*1
        ...
        # その後で1/1.7で割る
        df["place_season_condition_type_categori_processed_1"] = df["place_season_condition_type_categori_processed"] / 1.7
        ...
        # 出走レースのnoboriとの差分を計算
        df["nobori_diff"] = df["distance_place_type_race_class_around_weather_ground_state_nobori_encoded"] - df["nobori"]
        # df["pace_diff"]  = df["distance_place_type_race_class_around_weather_ground_state_pace_1_encoded"] - df["pace_1"]
        ...
        df["distance_correction"] = (df["course_len"] - distance_base) / 1000  # 分母を5000に変更し補正を小さく
        ...
        for n_race in tqdm(n_races, desc="agg_cross_zizoku_syunpatu"):
            ...
            df.columns = [
                "_".join(col) + f"_{n_race}races_encoded" for col in df.columns
            ]
            # オリジナルの統計値（mean, min）を保持
            original_df = df.copy()
    ...
    def cross_features_6(
        ...
        df_old2 = (
            ...
            .merge(self.race_info[["race_id", "place","weather","ground_state","race_class","course_len","race_type","race_date_day_count"]], on="race_id")
        )
    ...
    def cross_features_11(
        ...
        baselog = (
            ...
            .merge(
                self.race_info[["race_id","goal_slope"]], 
                on="race_id",
            )
            .query("date_horse < date")
            .sort_values("date_horse", ascending=False)
    ...
    def cross_features_12(
        ...
        baselog = (
            ...
            .merge(
                self.race_info[["race_id","curve",'place_season_condition_type_categori']], 
                on="race_id",
            )
            .query("date_horse < date")
            .sort_values("date_horse", ascending=False)
    ...
    def cross_features_13(
        ...
        def calculate_scores(baselog):
            ...
            #     (baselog["show"] == 1)
            # )
            # baselog.loc[condition5 & (baselog["show"] == 1), "score_pace_potision"] += (baselog["race_class"] + 1) / 3.6
