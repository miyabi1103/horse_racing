...
def def_predict_exe_dirt_nowin_tenkai(kaisai_date:str,race_id:str):
    ...
    # prediction.predict(
    #     features,
    #     model_filename="model_lightgbm_rank_niti_cv_full_dev_dirt_nowin_in3.pkl",
    ...
    prediction.predict(
        features,
        model_filename="model_lightgbm_rank_niti_cv_full_dev_dirt_nowin_only_tenkai_weight_in3.pkl",
...
def def_predict_exe_dirt_nowin(kaisai_date:str,race_id:str):
    ...
    prediction.predict(
        features,
        model_filename="model_lightgbm_rank_niti_cv_full_dev_dirt_noweight.pkl",
