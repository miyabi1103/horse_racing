...
def def_predict_exe_turf_ex(kaisai_date:str,race_id:str):
    pfc_turf = PredictionFeatureCreator(
        horse_results_filename = "horse_results_prediction_turf.csv",
        peds_filename = "peds_prediction_turf.csv",
        population_all_filename="population_turf.csv",
    ...
    prediction.predict(
        features,
        model_filename= "model_lightgbm_rank_niti_cv_full_dev_turf_only_tenkai_ex_in3.pkl",
...
# def def_predict_exe_turf_ex_2(kaisai_date:str,race_id:str):
#     pfc_turf = PredictionFeatureCreator(
#         horse_results_filename = "horse_results_prediction_turf.csv",
#         peds_filename = "peds_prediction_turf.csv",
#         population_all_filename="population_turf.csv",
