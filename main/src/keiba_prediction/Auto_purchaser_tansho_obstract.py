...
async def Auto_purchase_tansho_obstract(race_id:str,amount: str = "100",amount_num: str = "1"):
    ...
    try:
        ...
        filtered = df[(df["pred"] > 0.1) & (df["tansho_odds"] < 100) & (df["Ex_value"] > 1.5)]
    ...
    async with async_playwright() as playwright:
        ...
        await context.close()
        await browser.close()
        print("障害レース、単勝投票が完了しました")
        print("投票対象:", umaban_list)

if __name__ == "__main__":
    asyncio.run(Auto_purchase_tansho_obstract())
