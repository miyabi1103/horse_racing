...
def scrape_job(race_id:str, row: dict):
    ...
    if row['EARLY'] == 1 and row["type"] == 1 and row["class"] >= 2:
        ...
        money = asyncio.run(Auto_purchaser_sanrentan.Auto_purchase_sanrentan(race_id=race_id,amount = "200",amount_num = "4"))
...
if __name__ == "__main__":
    ...
    early_rows['post_time'] = early_rows['post_time'] - pd.Timedelta(minutes=7)
