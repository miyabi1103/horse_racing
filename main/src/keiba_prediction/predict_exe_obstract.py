...
def def_predict_exe_obstract(kaisai_date:str,race_id:str):
    pfc_obstract = PredictionFeatureCreator(
        horse_results_filename = "horse_results_prediction_obstract.csv",
        peds_filename = "peds_prediction_obstract.csv",
        old_population_filename="population_obstract.csv",
        old_results_filename="results_obstract.csv",
        old_race_info_filename="race_info_obstract.csv",
        old_horse_results_filename="horse_results_obstract.csv",
    )
    # 過去成績集計は事前に行うことができる
    pfc_obstract.create_baselog()
    pfc_obstract.agg_horse_n_races()
    ...
    # 特徴量の更新
    features = pfc_obstract.create_features(
        race_id=race_id,  # 予測するレースidを指定
