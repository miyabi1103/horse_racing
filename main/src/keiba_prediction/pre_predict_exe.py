...
def prepredict(kaisai_date:str):
    ...
    horse_results_preprocessed = preprocessing.process_horse_results(
        ...
        output_filename="horse_results_prediction_turf.csv"
    )
    # 当日出走馬の血統テーブルの前処理
    peds_preprocessed = preprocessing.process_peds(
        input_filename="peds_prediction.csv",
        population_dir = POPULATION_DIR_NEW,
        output_filename="peds_prediction_turf.csv"
    )


    # 当日出走馬の過去成績テーブルの前処理_そのままで使えない未加工のデータを加工する_芝未勝利
    horse_results_preprocessed = preprocessing.process_horse_results(
        input_filename="horse_results_prediction.csv",
        population_dir = POPULATION_DIR_NEW,
        output_filename="horse_results_prediction_turf.csv"
    ...
    peds_preprocessed = preprocessing.process_peds(
        input_filename="peds_prediction.csv",
        population_dir = POPULATION_DIR_NEW,
        output_filename="peds_prediction_dirt.csv"
    )
    ...
    horse_results_preprocessed = preprocessing.process_horse_results(
        input_filename="horse_results_prediction.csv",
        population_dir = POPULATION_DIR_NEW,
        output_filename="horse_results_prediction_obstract.csv"
    )
    ...
    peds_preprocessed = preprocessing.process_peds(
        input_filename="peds_prediction.csv",
        population_dir = POPULATION_DIR_NEW,
        output_filename="peds_prediction_obstract.csv"
    )
