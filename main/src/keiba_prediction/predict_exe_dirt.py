...
def def_predict_exe_dirt(kaisai_date:str,race_id:str):
    ...
    prediction.predict(
        features,
        model_filename="model_lightgbm_rank_niti_cv_full_dev_dirt_only_tenkai.pkl",
...
# def def_predict_exe_dirt_tenkai(kaisai_date:str,race_id:str):
...
#     prediction.predict(
#         features,
#         model_filename="model_lightgbm_rank_niti_cv_full_dev_dirt_only_tenkai_weight_in3.pkl",
...
def def_predict_exe_dirt_tenkai_in3(kaisai_date:str,race_id:str):
