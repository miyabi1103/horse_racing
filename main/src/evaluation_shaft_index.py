...
class Evaluator_lightgbm_index_shaft:
    def __init__(
        self,
        return_tables_filename: str = "return_tables.pickle",
        preprocessed_dir: Path = PREPROCESSED_DIR,
        train_dir: Path = TRAIN_DIR,
        evaluation_filename: str = "evaluation_lightgbm_index.csv",
    ...
    def box_top_n(
        ...
        agg_hitrate_one_head = (
            ...
            .groupby("bet_type")
            .mean()
            .rename(f"hitrate_one_head_{exp_name}")
            .to_frame()
        )
        agg_hitrate_two_head = (
            ...
            .groupby("bet_type")
            .mean()
            .rename(f"hitrate_two_head_{exp_name}")
            .to_frame()
        )
        ...
        agg_hitrate_one_head_tai = (
            ...
            .groupby("bet_type")
            .mean()
            .rename(f"hitrate_one_head_tai_{exp_name}")
            .to_frame()
        )
        agg_hitrate_two_head_tai = (
            ...
            .groupby("bet_type")
            .mean()
            .rename(f"hitrate_two_head_tai_{exp_name}")
            .to_frame()
        )
        ...
        agg_returnrate_one_head = (
            ...
            .rename(f"returnrate_one_head_{exp_name}")
            .to_frame()
            .reset_index()
        )
        ...
        agg_returnrate_two_head = (
            ...
            .rename(f"returnrate_two_head_{exp_name}")
            .to_frame()
            .reset_index()
        )
        ...
        agg_returnrate_one_head_tai = (
            ...
            .rename(f"returnrate_one_head_tai_{exp_name}")
            .to_frame()
            .reset_index()
        )
        ...
        agg_returnrate_two_head_tai = (
            ...
            .rename(f"returnrate_two_head_tai_{exp_name}")
            .to_frame()
            .reset_index()
        )
    ...
    def summarize_box_top_n(
        ...
        n: int = 5,
        exp_name: str = "model",
        save_filename: str = "box_summary_lightgbm_index_shaft.csv",
    ) -> pd.DataFrame:
        """
