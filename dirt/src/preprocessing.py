...
def process_horse_results(
    ...
    # df = df[df["race_type"] != 1](芝はいる？いらない？)
    ...
    conversion_map = {
        ...
        '510': -1, '520': -1, '530': -1, '540': -1,
        '810': -1, '820': -1, '830': -1, '840': -1,
        '110': -2, '120': -2, '130': -2, '140': -2,
        '210': -2, '220': -2, '230': -2, '240': -2,
        '1010': -2, '1020': -2, '1030': -2, '1040': -2,
        '310': -2, '320': -2, '330': -2, '340': -2,
        '410': -2, '420': -2, '430': -2, '440': -2,
        '910': -2, '920': -2, '930': -2, '940': -2,
        '710': -3, '720': -3, '730': -3, '740': -3,
        '610': -3, '620': -3, '630': -3, '640': -3
    }
