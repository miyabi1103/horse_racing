...
class PredictionFeatureCreator:
    ...
    def cross_features_2(self):
        ...
        baselog_old = (
            self.old_population.merge(
                self.old_race_info[["race_id", "course_len", "race_type", "around"]], on="race_id"
            )
            .merge(
        ...
        df_old = (
            baselog_old
            .merge(self.old_results[["race_id", "horse_id", "sex"]], on=["race_id", "horse_id"])
        )
        ...
        merged_df = merged_df.merge(
            df[[
                ...
                "distance_place_type_race_class_straight_ground_state","distance_place_type_race_class_around_weather_ground_state",
                "distance_place_type_umaban_race_class_around_weather_ground_state",
                "distance_place_type_ground_state_weather",
                ...
                "distance_place_type_umaban_race_class_around_weather_ground_state_nobori_encoded","distance_place_type_race_class_nobori_encoded","distance_place_type_ground_state_weather_nobori_encoded","distance_place_type_nobori_encoded",
    ...
    def cross_features_3(
        ...
        # df2_subset = df_old[["distance_type",'distance_type_encoded']].drop_duplicates()  # 重複を削除
        # df2_subset = df2_subset.reset_index(drop=True)
        # df = df.merge(df2_subset, on="distance_type", how='left')

        # df2_subset = df_old[["distance_place_type",'distance_place_type_encoded']].drop_duplicates()  # 重複を削除
        # df2_subset = df2_subset.reset_index(drop=True)
        # df = df.merge(df2_subset, on="distance_place_type", how='left')


        # df2_subset = df_old[["distance_place_type_race_class",'distance_place_type_race_class_encoded']].drop_duplicates()  # 重複を削除
        # df2_subset = df2_subset.reset_index(drop=True)
        # df = df.merge(df2_subset, on="distance_place_type_race_class", how='left')
        ...
        # # 各列ごとに個別に重複を削除する
        # for col in [, , , 
        #             "distance_place_type_wakuban", "distance_place_type_umaban", 
        #             "distance_place_type_wakuban_race_class", "distance_place_type_umaban_race_class", 
        #             "distance_place_type_wakuban_straight", "distance_place_type_umaban_straight", 
        #             "distance_place_type_wakuban_ground_state", "distance_place_type_umaban_ground_state", 
        #             "distance_place_type_wakuban_ground_state_straight", "distance_place_type_umaban_ground_state_straight", 
        ...
        #             'distance_place_type_wakuban_encoded', 'distance_place_type_umaban_encoded', 
        #             'distance_place_type_wakuban_race_class_encoded', 'distance_place_type_umaban_race_class_encoded', 
        #             'distance_place_type_wakuban_straight_encoded', 'distance_place_type_umaban_straight_encoded', 
        #             'distance_place_type_wakuban_ground_state_encoded', 'distance_place_type_umaban_ground_state_encoded', 
        #             'distance_place_type_wakuban_ground_state_straight_encoded', 
        #             'distance_place_type_umaban_ground_state_straight_encoded', 'distance_type_weather_encoded', 
        #             'distance_place_type_weather_encoded', 'distance_place_type_race_class_weather_encoded', 
        #             'distance_type_ground_state_encoded', 'distance_place_type_ground_state_encoded', 
        #             'distance_place_type_race_class_ground_state_encoded', 'distance_type_sex_encoded', 
        #             'distance_place_type_sex_encoded', 'distance_place_type_race_class_sex_encoded', 
        #             'distance_type_sex_weather_encoded', 'distance_place_type_sex_weather_encoded', 
        #             'distance_place_type_race_class_sex_weather_encoded', 'distance_type_sex_ground_state_encoded', 
        #             'distance_place_type_sex_ground_state_encoded', 
        #             'distance_place_type_race_class_sex_ground_state_encoded', 'distance_type_straight_encoded', 
        #             'distance_place_type_straight_encoded', 'distance_place_type_race_class_straight_encoded', 
        #             'distance_type_straight_ground_state_encoded', 'distance_place_type_straight_ground_state_encoded', 
        #             'distance_place_type_race_class_straight_ground_state_encoded']:
        #     df2_subset = df2_subset.drop_duplicates(subset=[col])
...
"distance_place_type_race_class_around_weather_ground_state_encoded_rank_diff_multiprod",
    ...
    def cross_features_6(
        ...
        df_old2 = (
            ...
            .merge(self.old_race_info_condition[["race_id", "place","weather","ground_state","race_class","course_len","race_type","race_date_day_count"]], on="race_id")
        )
