...
class Evaluator_lightgbm_rank_niti_cross_ex_value:
    def __init__(
        self,
        return_tables_filename: str = "return_tables.pickle",
        preprocessed_dir: Path = PREPROCESSED_DIR,
        train_dir: Path = TRAIN_DIR,
        evaluation_filename: str = "evaluation_lightgbm_rank_niti_cv_dev_turf",
    ...
    def box_top_n(
        ...
        self.evaluation_df = self.evaluation_df.query("2000 <= course_len")
        ...
        # self.evaluation_df = self.evaluation_df.query("-10 <= race_class")
        ...
        # "稍重": 2,
        # "不良": 3
        self.evaluation_df["tansho_odds_2"] = self.evaluation_df["tansho_odds"]

        # 100以上の値をNaNに置き換える
        self.evaluation_df.loc[self.evaluation_df["tansho_odds_2"] >= 80, "tansho_odds_2"] = 1

        self.evaluation_df["ex_value"] = self.evaluation_df ["pred"] * self.evaluation_df["tansho_odds_2"]
