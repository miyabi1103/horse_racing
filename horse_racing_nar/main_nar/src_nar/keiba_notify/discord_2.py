...
if not WEBHOOK_URL_2:
    raise ValueError("Discord Webhook URLが設定されていません。'.env'ファイルを確認してください。")


def post_discord_message_2(message: str):
    data = {"content": message}
    try:
        response = requests.post(WEBHOOK_URL_2, json=data)
...
def send_race_info_before_image_2():
    ...
    try:
        ...
        post_discord_message_2(message)
