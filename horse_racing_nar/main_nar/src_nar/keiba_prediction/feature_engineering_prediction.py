...
class PredictionFeatureCreator:
    ...
    def fetch_results(
        ...
        soup = BeautifulSoup(html, "lxml").find("table", class_="RaceTable01")
        horse_id_list = []
        ...
        # jockey_id_list = []
        # for a in a_list:
        #     match = re.findall(r"[A-Za-z\d]{5}", a.get("href", ""))
        ...
        # for a in a_list:
        #     matches = re.findall(r"[A-Za-z\d]{5}", a["href"])
        #     if matches:
    ...
    def fetch_race_info(
        ...
        divs = soup.find_all("div", class_="RaceData01")
        div1 = divs[0].text.replace(" ", "")
        # "RaceData02" の div を取得
        divs_02 = soup.find_all("div", class_="RaceData02")
        div2 = divs_02[0].text.replace(" ", "") 
        div1= div1 + div2
        ...
        try:
            info_dict["date"] = pd.to_datetime(date_content_a, format="%Y%m%d")
        except ValueError:
        ...
        df["kaisai_race"] = df["kaisai_race"].fillna("6")
        ...
        conversion_map = {
            ...
            # '30110': -3, '30120': -3, '30210': -3, '30220': -3, '30310': -3, '30320': -3, '30410': -4, '30420': -4,
            # '35110': -3, '35120': -3, '35210': -3, '35220': -3, '35310': -3, '35320': -3, '35410': -4, '35420': -4,
            # '36110': -3, '36120': -3, '36210': -3, '36220': -3, '36310': -3, '36320': -3, '36410': -4, '36420': -4,
            # '42110': -3, '42120': -3, '42210': -3, '42220': -3, '42310': -3, '42320': -3, '42410': -4, '42420': -4,
            # '43110': -2, '43120': -2, '43210': -2, '43220': -2, '43310': -2, '43320': -2, '43410': -3, '43420': -3,
            # '44110': -1, '44120': -1, '44210': -1, '44220': -1, '44310': -1, '44320': -1, '44410': -2, '44420': -2,
            # '45110': -1, '45120': -1, '45210': -1, '45220': -1, '45310': -1, '45320': -1, '45410': -2, '45420': -2,
            # '46110': -3, '46120': -3, '46210': -3, '46220': -3, '46310': -3, '46320': -3, '46410': -4, '46420': -4,
            # '47110': -2, '47120': -2, '47210': -2, '47220': -2, '47310': -2, '47320': -2, '47410': -3, '47420': -3,
            # '48110': -2, '48120': -2, '48210': -2, '48220': -2, '48310': -2, '48320': -2, '48410': -3, '48420': -3,
            # '50110': -3, '50120': -3, '50210': -3, '50220': -3, '50310': -3, '50320': -3, '50410': -4, '50420': -4,
            # '54110': -3, '54120': -3, '54210': -3, '54220': -3, '54310': -3, '54320': -3, '54410': -4, '54420': -4,
            # '51110': -3, '51120': -3, '51210': -3, '51220': -3, '51310': -3, '51320': -3, '51410': -4, '51420': -4,
            # '55110': -1, '55120': -1, '55210': -1, '55220': -1, '55310': -1, '55320': -1, '55410': -2, '55420': -2
        ...
        race_i = self.race_info_before.copy()
    ...
    def agg_course_len(
        ...
        baselog_df_info = self.baselog.merge(
                self.race_info[["race_id", "course_len", "race_grade"]], on="race_id", suffixes=("", "_info")
            )
        ...
        baselog_df["race_grade_diff"] = baselog_df["race_grade_info"] - baselog_df["race_grade"]
    ...
    def cross_features_15(
        ...
        grades = [55,60,70,79,85,  89,  91,  94,  98,61,62,63,64,65,66,67,68,69,71,72,73,74,75,76,77,78]
        ...
        # 1. 補完する順番を指定
        grades = [70, 79,78,77,76,75,74,73,72,71,69,68,67,66,65,64,63,62,61,85, 89, 60, 91,  94, 55, 98]
