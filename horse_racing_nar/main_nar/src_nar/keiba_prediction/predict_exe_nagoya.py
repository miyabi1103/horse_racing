...
def def_predict_exe_nagoya(kaisai_date:str,race_id:str):
    ...
    prediction.predict(
        features,
        model_filename="model_lightgbm_rank_niti_cv_full_dev_dirt_nagoya.pkl",
        config_filepath="config_lightgbm_niti_dev_dirt7.yaml"
    )
