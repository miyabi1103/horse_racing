...
def def_predict_exe_sonoda(kaisai_date:str,race_id:str):
    ...
    prediction.predict(
        features,
        model_filename="model_lightgbm_rank_niti_cv_full_dev_dirt_sonoda.pkl",
        config_filepath="config_lightgbm_niti_dev_dirt10.yaml"
    )
