...
class Trainer_lightgbm_rank_kaiki:
    def __init__(
        self,
    ...
    def create_dataset(self, valid_start_date: str, test_start_date: str):
        ...
        """
        # 目的変数
        self.features["target"] = self.features["rank"]
        # 学習データとテストデータに分割
        ...
        # 「馬の過去成績」の欠損率
        self.valid_df = self.valid_df.query('rank_3races.isna()')
        self.test_df = self.test_df.query('rank_3races.isna()')
    def train(
        self,
    ...
    def run(
        ...
        test_start_date: str,
        importance_filename: str = "importance_lightgbm_rank_kaiki",
        model_filename: str = "model_lightgbm_rank_kaiki.pkl",
